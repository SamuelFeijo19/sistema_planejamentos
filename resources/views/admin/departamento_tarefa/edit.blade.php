                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <input type="text" class="text-dark input-group" name="descricao" id="descricao"
                                               placeholder="DESCRIÇÃO:" value="{{ $tarefa->descricao }}">
                                    </div>
                                    @error('descricao')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <input type="text" class="text-dark input-group" name="numeroChamado"
                                               id="numeroChamado"
                                               placeholder="Número do Chamado (Quando houver):" value="{{ $tarefa->numeroChamado }}">
                                    </div>
                                    @error('numeroChamado')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="text-dark input-group" name="data_conclusao_prevista"
                                               id="data_conclusao_prevista" value="{{$tarefa->data_conclusao_prevista}}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="classificacao"
                                                   id="classificacao" value="0" {{ $tarefa->classificacao == 0 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="inlineRadio1">Baixa Prioridade</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="classificacao"
                                                   id="classificacao" value="1" {{ $tarefa->classificacao == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="inlineRadio2">Média Prioridade</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="classificacao"
                                                   id="classificacao" value="2" {{ $tarefa->classificacao == 2 ? 'checked' : '' }}>
