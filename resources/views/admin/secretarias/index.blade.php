...
@section('content')
    <div class="container-fluid">
        <div style="width: 100%;">
            ...
            <x-search.search-button placeholder="Busque por Secretarias"
                                    form-action="{{ route('secretarias.index') }}"/>
                ...
                <div class="list-group">
                    @foreach ($secretarias as $secretaria)
                        <div class="list-group-item shadow-sm border-left-info">
                            <div class="row">
                                <div class="col">
                                    <p class="mb-1"><b>Nome:</b> {{ucwords(mb_strtolower($secretaria->nomeSecretaria))}}
                                    </p>
