                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="hidden" name="departamento_id"
                                               value="{{$divisao->departamento_id}}">

                                        <div class="form-group">
                                            <input type="text" class="text-dark input-group" name="nomeDivisao"
                                                   id="nomeDivisao"
                                                   placeholder="NOME DA DIVISÃO:" value="{{$divisao->nomeDivisao}}">
                                        </div>
                                        @error('nomeDivisao')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="administrador_id" for="administrador_id" class="js-example-basic-single custom-select" id="inputGroupSelect01">
                                                ...
                                                @foreach ($servidores as $servidor)
                                                    <option value="{{ $servidor->id }}" {{ $servidor->id == $divisao->administrador_id ? 'selected' : '' }}>
                                                        {{ mb_strtoupper($servidor->user->name) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
