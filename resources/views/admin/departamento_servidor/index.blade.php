    ...
    <div class="container-fluid">
        <div style="width: 100%">
            <div class="col col-12">
                <h3>Servidores Cadastrados no {{ ucwords(mb_strtolower($departamento->nomeDepartamento)) }}</h3>
                                ...
                                @if(auth()->user()->is_admin)
                                    <div class="col d-flex justify-content-center align-items-center">
                                        <div class="text-right">
                                            <a href="#" class="delete"
                                               data-route="{{ route('departamentoServidor.destroy', $lotacao->id) }}" title="EXCLUIR LOTAÇÃO DO SERVIDOR">
