    ...
    <main class="container-fluid">
        <div class="row">
            <div class="col col-12">
                <h3>Edição de Servidor</h3>
                <hr>
            </div>
            <div class="shadow-lg" style="width: 80%; margin:0 auto; border-radius: 7px;">
                <form id="formulario_registro" method="post" action="{{ route('servidores.update', $servidor->id) }}">
                    @csrf
                    @method('PUT')
                    <div >
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="text-dark input-group" name="dataNascimento"
                                               id="dataNascimento" placeholder="" value="{{$servidor->data_nascimento}}">
                                    </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="text-dark input-group" name="cpf" id="cpf"
                                               placeholder="CPF:" value="{{$servidor->cpf}}">
                                    </div>
                                    @error('cpf')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="text-dark input-group" name="matricula" id="matricula"
                                               placeholder="MATRÍCULA:" value="{{$servidor->matricula}}">
                                    </div>
                                    @error('matricula')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
