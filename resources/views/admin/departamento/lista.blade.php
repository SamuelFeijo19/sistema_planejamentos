                        ...
                        <div class="list-group-item shadow-sm border-left-info">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p class="mb-1">
                                        <b>Secretaria:</b> {{ucwords(mb_strtolower($departamento->secretaria->nomeSecretaria))}}
                                    </p>
